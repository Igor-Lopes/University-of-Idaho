...
/* the following can appear after a Op_Synt:
 * any case endcase if endif ifelse endifelse while endwhile every endevery
 * until enduntil repeat endrepeat suspend endsuspend
 */
